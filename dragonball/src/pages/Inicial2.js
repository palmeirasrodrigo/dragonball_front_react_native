  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <TouchableWithoutFeedback onPressIn={this.handleAirhorn2} onPressOut={()=>{this.handleButtonUp2, this.props.navigation.navigate("TimeLine", {estrela:2});}}>
          <View style={styles.button}>
            <View style={styles.outer}>
        ...
        <TouchableWithoutFeedback onPressIn={this.handleAirhorn3} onPressOut={()=>{this.handleButtonUp3, this.props.navigation.navigate("TimeLine", {estrela:3});}}>
          <View style={styles.button}>
            <View style={styles.outer}>
        ...
        <TouchableWithoutFeedback onPressIn={this.handleAirhorn4} onPressOut={()=>{this.handleButtonUp4, this.props.navigation.navigate("TimeLine", {estrela:4});}}>
          <View style={styles.button}>
            <View style={styles.outer}>
        ...
        <TouchableWithoutFeedback onPressIn={this.handleAirhorn5} onPressOut={()=>{this.handleButtonUp5, this.props.navigation.navigate("TimeLine", {estrela:5});}}>
          <View style={styles.button}>
            <View style={styles.outer}>
        ...
        <TouchableWithoutFeedback onPressIn={this.handleAirhorn6} onPressOut={()=>{this.handleButtonUp6, this.props.navigation.navigate("TimeLine", {estrela:6});}}>
          <View style={styles.button}>
            <View style={styles.outer}>
        ...
        <TouchableWithoutFeedback onPressIn={this.handleAirhorn7} onPressOut={()=>{this.handleButtonUp7, this.props.navigation.navigate("TimeLine", {estrela:7});}}>
          <View style={styles.button}>
            <View style={styles.outer}>
